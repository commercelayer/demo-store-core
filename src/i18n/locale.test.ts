...
test('"makeLocaleCode" creates a localeCode given a countryCode and a languageCode', () => {
...
test('"makeLocales" should create locales from a list of countries and languages', () => {
...
test('"getLocale" should be able to return a Locale gived a localeCode', () => {
  const unitedStates: Country = { code: 'US', default_language: 'en', market: 400, name: 'United States' }
  const italian: Language = { code: 'it', name: 'Italiano' }
...
test('"getLocale" should return undefined when the localeCode is unknown', () => {
